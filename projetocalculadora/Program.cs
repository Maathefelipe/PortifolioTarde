...
namespace Calculadora_Basica
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            double valor1 = 0, valor2 = 0, resultado, numero; // usando double para ter mais precição nas casas da virgula (64 bits), atribuido 0 aos valores
            string operador, valorDigitado;
            bool numero_inteiro;

            Console.WriteLine("Digite o primeiro valor, depois aperter enter: ");
            ...
            switch (operador)
            {
                ...
                case "%":
                    ...
                    break;
                default:
                    Console.WriteLine("Digite uma operação válida, em seguida aperte enter");
                    break;
            }
